        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-[180px_1fr]">
          ...
          <div className="border-l border-ink-line pl-6">
            <div className="flex flex-wrap items-baseline justify-between gap-2">
              <h3 className="text-lg font-medium text-paper-bright">
                {experience.company}
              </h3>
            ...
            <p className="mt-1 text-sm italic text-paper-bright">
              {experience.role}
            </p>

            <ul className="mt-5 space-y-3 text-paper-bright">
              {experience.points.map((point) => (
                <li key={point} className="flex gap-3 leading-relaxed">
                  <span
                    className="mt-2.5 h-1 w-1 flex-none rounded-full bg-accent"
                    aria-hidden="true"
                  />
